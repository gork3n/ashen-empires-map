...
function initializeMap() {
    ...
    const initialCenterGameCoords = { x: 761, y: 115, }; // Default View is { x: 776, y: 668, } (Showing Lotor's Summer Palace) Centers LSP on smaller screens.
    ...
    map = new Map({ // Initialize the map
        ...
        view: new View({
            ...
            resolution: 1, // Set to 8 for zoom level 4
